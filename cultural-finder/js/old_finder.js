...
var FACET_INCLUDES = [];
var FACET_LABELS = {};
FACET_LABELS['provider'] = 'Data Provider';
                                    ...
                                    /*
                                       ...
                                       if (item.format.indexOf('pdf') != -1)
                                        ...
                                        item.format='ppt';
                                           ...
                                           item.format='audio';
                                       else if ((item.format.indexOf('text') != -1) ||(item.format.indexOf('multipart') != -1) || (item.format.indexOf('xml') != -1) )
                                           item.format='text';
